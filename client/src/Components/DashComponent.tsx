      ...
      <div className={styles.shortInfo}>
        ...
        <div className={styles.shortInfoBlock}>
          <div className={styles.total}>
            ...
            <div className={styles.totalAmount}>
            <CountUp end={totalComments} duration={2} className={styles.count} />
      ...
      <div className={styles.recent}>
        <div className={styles.recentUsers}>
          ...
          <div className={styles.recentUsersInfo}>
            ...
            <Link to={'/dashboard&tab=users'} className={styles.seeAll}>Ещё</Link>
          </div>
        </div>
        ...
        <div className={styles.recentPosts}>
          ...
          <div className={styles.recentPostsInfo}>
            ...
            <Link to={'/dashboard&tab=posts'} className={styles.seeAll}>Ещё</Link>
          </div>
        </div>
        ...
        <div className={styles.recentComments}>
          ...
          <div className={styles.recentCommentsInfo}>
            ...
            <Link to={'/dashboard&tab=comments'} className={styles.seeAll}>Ещё</Link>
          </div>
        </div>
      </div>
    </div>
