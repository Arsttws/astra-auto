    ...
    <div className={styles.wrapper}>
        ...
        <form className={styles.form} onSubmit={handleSubmit}>
            <div className={styles.postMainInfo}>
                <input className={styles.postTitle} type="text" placeholder="Введите название..." required onChange={(e)=> setFormData({...formData, title: e.target.value})} />
                <select className={styles.category} name="categories" id="category-select" onChange={(e)=> setFormData({...formData, category: e.target.value})}required>
            ...
            <div className={styles.imgSelect}>
                <input className={styles.chooseImage} type="file" accept="image/*" onChange={(e:any) => setImage(e.target.files[0])} required />
