    ...
    <div className="wrapper">
        ...
        <form onSubmit={handleSubmit}>
            <div className="postMainInfo">
                <input type="text" id="title" placeholder="Название" required onChange={(e)=> setFormData({...formData, title: e.target.value})} value={formData.title} />
                <select name="categories" id="category-select" onChange={(e)=> setFormData({...formData, category: e.target.value})} value={formData.category} required>
            ...
            <ReactQuill theme="snow" placeholder="Введите текст статьи" onChange={(value)=> setFormData({...formData, content: value})} value={formData.content} />
            <button type="submit">
                Обновить
            </button>
